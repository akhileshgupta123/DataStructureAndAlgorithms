...
public class MinJumpReachHome {
    ...
    private static int findHomePath(List<Integer> forbidden, int forwardJump, int backwardJump, int homePosition,
                                    boolean canGoBack, int currentPosition, int jumpsDone, Integer minimumJumps, Set<Integer> alreadyVisited) {
